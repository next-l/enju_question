class AddConstraintsToMostRecentForBookmarkStatTransitions < ActiveRecord::Migration[4.2]
  ...
  def up
    add_index :bookmark_stat_transitions, %i[bookmark_stat_id most_recent], unique: true, where: "most_recent", name: "index_bookmark_stat_transitions_parent_most_recent" # , algorithm: :concurrently
